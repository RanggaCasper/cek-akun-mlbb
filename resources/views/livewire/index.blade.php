<div>
    <div class="flex justify-center items-center min-h-screen mx-3">
        <div class="w-full max-w-lg p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
            <form class="space-y-6" wire:submit.prevent="store">
                ...
                <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" wire:loading.attr="disabled" wire:target="store">
            ...
            @if($result)
                ...
                @else
                    <p class="text-red-500 mt-3">{{ $result['message'] }}</p>
                @endif
